<?php
/**
 * Settings for open freight shipping.
 *
...
$settings = array(
    'title' => array(
        ...
        'default' => __('OpenFreight', 'woocommerce'),
        'desc_tip' => true,
    ),
    'tax_status' => array(
    ...
    'margin' => array(
        'title' => __('Freight Margin', 'woocommerce'),
        'type' => 'text',
        'placeholder' => '',
        'description' => 'Applied to quote estimate returned from OpenFreight',
        'default' => '0',
        'desc_tip' => true,
        'sanitize_callback' => array($this, 'sanitize_margin'),
    ),
);
