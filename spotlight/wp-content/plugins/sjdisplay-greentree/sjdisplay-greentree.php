...
require_once(plugin_dir_path(__FILE__) . 'class.sjdisplay-greentree-woo-emails.php');
require_once(plugin_dir_path(__FILE__) . 'class.sjdisplay-greentree-order-amendment.php');
...
add_action('init', array('SJDisplay_Greentree_Woo_Emails', 'init'));
add_action('init', array('SJDisplay_Greentree_Order_Amendment', 'init'));
