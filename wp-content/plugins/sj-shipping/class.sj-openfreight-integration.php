...
class SJ_Openfreight_Integration
{
    ...
    public static function custom_before_cart_messages()
    {
        ...
        //if there is no quote data and payment system is enabled, show error notification area
        if (!$openfreight_session_data['quote'] && get_option('greentree_payment_enabled')) {
            include_once('partials/woo-cart-notification-area.php');
        }
    }
    ...
    public static function custom_before_checkout_messages()
    {
        ...
        //if there is no quote data and payment system is enabled, show error notification area
        if (!$openfreight_session_data['quote'] && get_option('greentree_payment_enabled')) {
            include_once('partials/woo-checkout-notification-area.php');
        }
    }
