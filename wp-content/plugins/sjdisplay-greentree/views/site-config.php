...
<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row">Custom Email Subject<br>Area Manager Approval Required Notification</th>
                <td>
                    <input type="text" name="greentree_area_manager_approval_email_subject" class="regular-text"
                    value="<?= esc_attr(get_option('greentree_area_manager_approval_email_subject')) ?>">
                </td>
            </tr>

            <tr valign="top">
                <th scope="row">Custom Email Subject<br>Store Manager Approval Status Notification</th>
                <td>
                    <input type="text" name="greentree_store_manager_approval_email_subject" class="regular-text"
                           value="<?= esc_attr(get_option('greentree_store_manager_approval_email_subject')) ?>">
                </td>
            </tr>
